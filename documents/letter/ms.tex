...
companion stars given observations of the orbital period and projected radial velocity of the primary star. 
We then apply this model to a sample of low mass white dwarfs (LMWD).
We use a mixture of 
...
\begin{equation}
P_{\rm NS} = \frac{\int_{M_{2,{\rm min}}}^{\infty} dM_2~ f_{\rm NS}~ p_{\rm NS}~ h(M_2, \mf, M_1)}{\int_{M_{2,{\rm min}}}^{\infty} dM_2~ \left[ (1-f_{\rm NS})~p_{\rm WD} + f_{\rm NS}~p_{\rm NS} \right] ~ h(M_2, \mf, M_1)}\label{eq:P_NS}
\end{equation}
