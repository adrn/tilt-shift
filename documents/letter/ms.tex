...
\begin{align}
	...
	p_{\rm WD} &= \mathcal{N}(M_2 \given \mu_{\rm WD}, \sigma^2_{\rm WD}) \\
	p_{\rm NS} &= \mathcal{N}(M_2 \given \mu_{\rm NS}, \sigma^2_{\rm NS})
\end{align}
where $\mathcal{N}$ is the normal distribution with mean $\mu$ and variance $\sigma^2$. In this work, we fix the mean and variance of the neutron star distribution to
\begin{align}
	\mu_{\rm NS} &= 1.4~\Msun\\
	\sigma^2_{\rm NS} &= (0.2~\Msun)^2
\end{align}
...
\subsection{Single Gaussian (white dwarf)}

\subsection{Two Gaussians (white dwarf + neutron star)}

\subsection{Uniform (white dwarf) + Gaussian (neutron star)}
