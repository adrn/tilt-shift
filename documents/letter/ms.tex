...
script for computing the companion mass distribution and the NS probability for newly discovered low mass WDs given a measured WD mass and mass function.
\end{abstract}
